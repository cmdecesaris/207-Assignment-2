...
We have $F^*={\rm MSA}/{\rm MSE}$ that follows an F-distribution with $F(0.99, 2,526 )$. If $F^* > F(0.99, 2,526)$ then we rejuect the null hypothsis. 
...
```
$2.159\ngtr 2.159$ so $ F^* \ngtr F(0.99, 2,526)$ and therefore we do not reject the null hypothesis at significance level $\alpha=0.01$. 
